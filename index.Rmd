...
- Watch the video [Plotting with ggplot: Part 1](https://www.youtube.com/watch?v=HeqHMM4ziXA)
- Watch the video [Plotting with ggplot: Part 2](https://www.youtube.com/watch?v=n8kYa9vu1l8)
...
- Read the [dplyr Vignette](https://cran.rstudio.com/web/packages/dplyr/vignettes/introduction.html)
...
- Read Lewis-Beck &amp; Lewis-Beck (Chap. 1)
...
- Read Lewis-Beck &amp; Lewis-Beck (Chap. 2)
...
- Read Lewis-Beck &amp; Lewis-Beck (Chap. 3)
...
- Read [What is Dummy Coding?](http://www.ats.ucla.edu/stat/mult_pkg/faq/general/dummy.htm)
- Read [What is Effect Coding?](http://www.ats.ucla.edu/stat/mult_pkg/faq/general/effect.htm)
